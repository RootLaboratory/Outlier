...
private:
	...
	ECheckBoxState GetPixelSortingColorInterpolationCheckState() const;
	void OnPixelSortingColorInterpolationChanged(ECheckBoxState NewState);
	TOptional<float> GetPixelSortingTargetColorRValue() const;
	void OnPixelSortingTargetColorRChanged(float NewValue);
	TOptional<float> GetPixelSortingTargetColorGValue() const;
	void OnPixelSortingTargetColorGChanged(float NewValue);
	TOptional<float> GetPixelSortingTargetColorBValue() const;
	void OnPixelSortingTargetColorBChanged(float NewValue);
	TOptional<int32> GetPixelSortingResolutionDivisorValue() const;
	void OnPixelSortingResolutionDivisorChanged(int32 NewValue);

	ECheckBoxState GetZoomBlurEnabledCheckState() const;
	void OnZoomBlurEnabledChanged(ECheckBoxState NewState);
	TOptional<int32> GetZoomBlurTriggerThresholdValue() const;
	void OnZoomBlurTriggerThresholdChanged(int32 NewValue);
	TOptional<float> GetZoomBlurBlackoutStartProgressValue() const;
	void OnZoomBlurBlackoutStartProgressChanged(float NewValue);
	TOptional<int32> GetZoomBlurCurveValue() const;
	void OnZoomBlurCurveChanged(int32 NewValue);
	TOptional<int32> GetZoomBlurBlackoutCurveValue() const;
	void OnZoomBlurBlackoutCurveChanged(int32 NewValue);
	TOptional<float> GetZoomBlurFadeInTimeScaleValue() const;
	void OnZoomBlurFadeInTimeScaleChanged(float NewValue);
	TOptional<float> GetZoomBlurFadeOutTimeScaleValue() const;
	void OnZoomBlurFadeOutTimeScaleChanged(float NewValue);
	TOptional<float> GetZoomBlurBlackoutFadeInTimeScaleValue() const;
	void OnZoomBlurBlackoutFadeInTimeScaleChanged(float NewValue);
	TOptional<float> GetZoomBlurBlackoutFadeOutTimeScaleValue() const;
	void OnZoomBlurBlackoutFadeOutTimeScaleChanged(float NewValue);
	float GetZoomBlurMaximumStrengthSliderValue() const;
	TOptional<float> GetZoomBlurMaximumStrengthValue() const;
	void OnZoomBlurMaximumStrengthChanged(float NewValue);
	float GetZoomBlurStartOffsetSliderValue() const;
	TOptional<float> GetZoomBlurStartOffsetValue() const;
	void OnZoomBlurStartOffsetChanged(float NewValue);
	TOptional<int32> GetZoomBlurSampleCountValue() const;
	void OnZoomBlurSampleCountChanged(int32 NewValue);
	TOptional<int32> GetZoomBlurResolutionDivisorValue() const;
	void OnZoomBlurResolutionDivisorChanged(int32 NewValue);
